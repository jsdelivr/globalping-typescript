...
import type {
	...
	CreateMeasurementErrors,
	CreateMeasurementResponses,
	GetLimitsData,
	GetLimitsResponses,
	GetMeasurementData,
	GetMeasurementErrors,
	GetMeasurementResponses,
	ListProbesData,
	ListProbesResponses,
} from './types.gen.js';
 ...
 *
 */
export const createMeasurement = <ThrowOnError extends boolean = false>(
	options: Options<CreateMeasurementData, ThrowOnError>,
): RequestResult<CreateMeasurementResponses, CreateMeasurementErrors, ThrowOnError> => (options.client ?? client).post<CreateMeasurementResponses, CreateMeasurementErrors, ThrowOnError>({
	security: [
		{
			key: 'BearerAuth',
			scheme: 'bearer',
 ...
 *
 */
export const getMeasurement = <ThrowOnError extends boolean = false>(
	options: Options<GetMeasurementData, ThrowOnError>,
): RequestResult<GetMeasurementResponses, GetMeasurementErrors, ThrowOnError> => (options.client ?? client).get<GetMeasurementResponses, GetMeasurementErrors, ThrowOnError>({ url: '/v1/measurements/{id}', ...options });
 ...
 *
 */
export const listProbes = <ThrowOnError extends boolean = false>(
	options?: Options<ListProbesData, ThrowOnError>,
): RequestResult<ListProbesResponses, unknown, ThrowOnError> => (options?.client ?? client).get<ListProbesResponses, unknown, ThrowOnError>({ url: '/v1/probes', ...options });
 ...
 *
 */
export const getLimits = <ThrowOnError extends boolean = false>(
	options?: Options<GetLimitsData, ThrowOnError>,
): RequestResult<GetLimitsResponses, unknown, ThrowOnError> => (options?.client ?? client).get<GetLimitsResponses, unknown, ThrowOnError>({
	security: [
		{
			key: 'BearerAuth',
			scheme: 'bearer',
