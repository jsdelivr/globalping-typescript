 ...
 */
export const PingProtocol = { ICMP: 'ICMP', TCP: 'TCP' } as const;

/**
 * The transport protocol to use.
 */
export type PingProtocol = (typeof PingProtocol)[keyof typeof PingProtocol];

/**
 * EXPERIMENTAL: The IP version to use. Only allowed if the target is a hostname.
 *
 */
export const IpVersion = { 4: 4, 6: 6 } as const;
 ...
 * The type of DNS query.
 */
export type DnsQueryType = (typeof DnsQueryType)[keyof typeof DnsQueryType];

/**
 * A DNS resolver to use for the query. Defaults to the probe system resolver.
 */
export type DnsMeasurementResolver = string;

/**
 * The protocol to use for the DNS query.
 */
export const DnsProtocol = { TCP: 'TCP', UDP: 'UDP' } as const;
...
export type MeasurementDnsOptions = {
	...
	resolver?: DnsMeasurementResolver;
 ...
 * The transport protocol to use.
 */
export type MtrProtocol = (typeof MtrProtocol)[keyof typeof MtrProtocol];
 ...
 * A DNS resolver to use for the query. Defaults to the probe system resolver.
 */
export type HttpMeasurementResolver = string;
...
export type MeasurementHttpOptions = {
	...
	resolver?: HttpMeasurementResolver;
 ...
 * A two-letter continent code.
 */
export type ContinentCode = (typeof ContinentCode)[keyof typeof ContinentCode];
...
export type StatsStDevNullable = NullableNumber & unknown;

export type StatsJitterMinNullable = NullableNumber & unknown;

export type StatsJitterAvgNullable = NullableNumber & unknown;

export type StatsJitterMaxNullable = NullableNumber & unknown;
...
export type FinishedMtrTestResult = BaseFinishedTestResult & {
	...
	hops: Array<{
		...
		stats: {
			...
			avg: StatsRttAvgNullable;
			max: StatsRttMaxNullable;
			stDev: StatsStDevNullable;
			jMin: StatsJitterMinNullable;
			jAvg: StatsJitterAvgNullable;
			jMax: StatsJitterMaxNullable;
			total: StatsPacketsTotal;
			rcv: StatsPacketsRcv;
			drop: StatsPacketsDrop;
			loss: StatsPacketsLoss;
 ...
 * The type of the used key, or `null` for unrecognized types.
 */
export type TlsKeyType = (typeof TlsKeyType)[keyof typeof TlsKeyType];
 ...
 */
export const MeasurementStatus = { IN_PROGRESS: 'in-progress', FINISHED: 'finished' } as const;
...
/**
 * EXPERIMENTAL: The most likely source of the failure:
 ...
 */
export const RateLimitType = { IP: 'ip', USER: 'user' } as const;
...
export type CreateMeasurementErrors = {
	...
	400: {
		...
		links?: {
			...
			/**
			 * A link to documentation for the relevant endpoint.
			 */
